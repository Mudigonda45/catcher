...
color_cycle = cycle(['light blue','light pink','light yellow','red','blue','green','black'])
egg_width = 45
egg_height=55
egg_score =10
egg_speed = 500
...
brand = c.create_text(canvas_width/2,10,anchor='n' , font=('Arial',12,'bold'),fill='black',text='Designed by Vinay Bhushan ' )
